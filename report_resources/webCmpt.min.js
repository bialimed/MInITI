...
/*!
  * AnaCore-web msi-loci-table v2.2.0
  * Copyright 2018 CHU-Toulouse
  * Author Frederic Escudie
  * Licensed under GNU General Public License
  */
function mlt_getScoreClasses(t,e){let s="danger";return e.forEach(e=>{const[n,a]=e;n<=t&&(s=a)}),["msi-label","msi-label-"+s]}const MSILociTable=Vue.component("msi-loci-table",{props:{analysis:{type:Object,required:!0},class_by_score:{type:Object,default:function(){return{.7:"danger",.95:"good"}}},has_chart_lnk:{type:Boolean},reference_method:{type:String},table_title:{default:"Status by locus",type:String}},computed:{rows_data:function(){return Object.values(this.analysis.getResByLocus())},header:function(){const t=this;let e=[];0!=this.has_chart_lnk&&e.push({rowspan:2,event:"see-distrib",header_class:"no-sort",help:"Display length distribution",is_html:!0,title:"Lengths",value:function(t,e){return'<button type="button" class="btn btn-primary">\n                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" viewBox="0 0 512 512">\n                                <path d="M32 32C49.67 32 64 46.33 64 64V400C64 408.8 71.16 416 80 416H480C497.7 416 512 430.3 512 448C512 465.7 497.7 480 480 480H80C35.82 480 0 444.2 0 400V64C0 46.33 14.33 32 32 32zM160 224C177.7 224 192 238.3 192 256V320C192 337.7 177.7 352 160 352C142.3 352 128 337.7 128 320V256C128 238.3 142.3 224 160 224zM288 320C288 337.7 273.7 352 256 352C238.3 352 224 337.7 224 320V160C224 142.3 238.3 128 256 128C273.7 128 288 142.3 288 160V320zM352 192C369.7 192 384 206.3 384 224V320C384 337.7 369.7 352 352 352C334.3 352 320 337.7 320 320V224C320 206.3 334.3 192 352 192zM480 320C480 337.7 465.7 352 448 352C430.3 352 416 337.7 416 320V96C416 78.33 430.3 64 448 64C465.7 64 480 78.33 480 96V320z"/>\n                            </svg>\n                        </button>'}}),e.push({rowspan:2,help:"Locus coordinates",title:"Coordinates",value:function(t,e){return t[0].position}}),this.analysis.existsLocusName()&&e.push({rowspan:2,help:"Locus name",title:"Name",sort:"asc",value:function(t,e){return t[0].name}});let s=[];return this.analysis.samples.forEach(function(n,a){const i=n.getMethods(),r=t.reference_method?t.reference_method:i[0],o=i.length+1;e.push({colspan:o,title:n.name}),i.forEach(function(e){e==r&&s.splice(a*o,0,{title:"Support",help:"Number of reads analysed.",value:function(t,s){const n=t[a].results[e],i=n.data.hasOwnProperty("nb_by_length")?n.data.nb_by_length:n.data.lengths.ct_by_len;return Object.values(i).reduce(function(t,e){return t+e},0)}}),s.push({title:`${e} classification`,class:"msi-sticker",entryClass:function(t,s){return t[a].results[e].status},help:`Stability status and if it exists its confidence score. [predicted by ${e}]`,is_html:!0,value:function(s,n){let i=[],r=s[a].results[e].score;if(null!=r){const e=mlt_getScoreClasses(r,t.scores_classes).join(" ");i.push(`<span class="${e}">${r.toFixed(2)}</span>`)}let o=s[a].results[e].status;return"Undetermined"==o&&(o="Unknown"),i.push(o),i.join(" ")}})})}),[e,s]},scores_classes:function(){return Object.keys(this.class_by_score).sort(function(t,e){return parseFloat(t)-parseFloat(e)}).map(t=>[parseFloat(t),this.class_by_score[t]])}},methods:{seeDistrib:function(t){this.$emit("see-distrib",t)}},template:'<dynamic-table\n        v-on:see-distrib="seeDistrib"\n        :data="rows_data"\n        export_title="msi_loci"\n        :header="header">\n    </dynamic-table>'});


/*!
  * AnaCore-web msi-loci-card v2.1.0
  * Copyright 2018 CHU-Toulouse
  * Author Frederic Escudie
  * Licensed under GNU General Public License
  */
const MSILociCard=Vue.component("msi-loci-card",{props:{analysis:{type:Object,required:!0},class_by_score:{type:Object,default:function(){return{.7:"danger",.95:"good"}}},model_peaks:{type:Object},reference_method:{required:!0,type:String},loci_select_threshold:{type:Object,default:function(){return new ThresholdAlert({100:"danger",0:"good"},"","of samples with insufficient support","%")}}},data:function(){return{selected_locus:null}},created:function(){mlc_class_by_score=this.class_by_score;const e=this.analysis.getLocusNameByLocusID(),s=Object.keys(e).sort(function(s,t){return e[s]>e[t]});this.selected_locus=s[0]},computed:{options_select_locus:function(){let e=null;if(null!=this.analysis){e=[];const s=this.analysis.getLocusNameByLocusID();Object.keys(s).sort(function(e,t){return s[e]<s[t]}).forEach(function(t){e.splice(0,0,{value:t,label:s[t]})})}return e},loci_select_support:function(){return(100*(this.analysis.samples.length-this.analysis.getNbDeterminedForLocus(this.selected_locus,this.reference_method))).toFixed(0)}},template:'<div>\n        \x3c!-- loci graph --\x3e\n        <div class="row row-block">\n            <div class="col-md-10">\n                <msi-loci-graph\n                    :report="analysis"\n                    :undetermined_are_visible="false"\n                    :models_peaks_by_locus="model_peaks"\n                    :locus_id="selected_locus"\n                    :method="reference_method">\n                </msi-loci-graph>\n            </div>\n            <div class="col-md-2">\n                <select class="custom-select" v-model="selected_locus">\n                    <option v-for="option in options_select_locus" :value="option.value">\n                        {{option.label}}\n                    </option>\n                </select>\n                <div style="margin-top: 5px;">\n                    <threshold-alert\n                        :threshold="loci_select_threshold"\n                        :value="loci_select_support">\n                    </threshold-alert>\n                </div>\n            </div>\n        </div>\n        \x3c!-- loci table --\x3e\n        <div class="row">\n            <div class="col-md-12">\n                <msi-loci-table\n                    :analysis="analysis"\n                    :class_by_score="class_by_score"\n                    :reference_method="reference_method"\n                    title="Status by locus">\n                </msi-loci-table>\n            </div>\n        </div>\n    </div>'});
